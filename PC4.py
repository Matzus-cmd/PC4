...
if pagina_seleccionada == 'Inicio':
    ...
    st.markdown("<h1 style='text-align: center;'>Conociendo Python: Matias Zusnabar</h1>", unsafe_allow_html=True)
    ...
    col1.image("fotodeperfil.png.jpeg", caption='Yo actualmente', width=300)
    ...
    texto = """
    Buen día, me llamo Matías Zusnabar, soy estudiante de la PUCP, y llevo aquí unos 2 años. 
    Provengo de la provincia de Lima.
    Desde hace un tiempo me decanté por la carrera de Comunicación Audiovisual, 
    parte de mi elección se debe a que siempre quise aprender el proceso 
    de producción y grabación cinematográfica. 
    Más adelante me gustaría trabajar como productor o director para empresas importantes de películas, 
    Por ahora disfruto de mi tiempo libre jugando fútbol y viendo documentales, de alguna manera con ello
    me mantengo entretenido y en constante disfrute.
    """
    ...
    # Agregamos un título
    st.markdown("<h1 style='text-align: center;'>¿Cómo fue mi experiencia en la programación? 💻</h1>", unsafe_allow_html=True)
    ...
    texto_2 = """
    Gracias a que anteriormente había llevado un curso extracurricular
    sobre Python, me sentía confiado y no me costó volver a adaptarme a las lineas de código y sus diversos 
    elementos.
    Considero que la experiencia de programar me ha enseñado a organizar mejor mis ideas, ya que tiene una
    interfaz que me hace sentir cómodo y seguro, tal vez sea porque se pueden predecir los errores y evitarlos.
    Me gusta programar con librerias interactivas como Matplotlib, Wordcloud, y Folium, ya que le agregan una dimensión
    más interactiva y gráfica a la línea de código.
    A decir verdad, creo que podría volver a usar Visual Studio Code para experimentar con los diversos códigos e 
    incluso desarrollar mis propios blogs en la web para uso profesional.
    """
    ...
    st.markdown("<h2 style='text-align: center;'>En este video estuve desarrollando el tema referente a las condiciones IF, ELIF y ELSE</h2>", unsafe_allow_html=True)
    ...
    #st.video("https://drive.google.com/file/d/1drMmmhtIDBtVsC_42SE5kHT9FlHEBeAx/view?usp=sharing")
    ...
    st.markdown(f"<div style='text-align: center;'><a href='https://drive.google.com/file/d/1drMmmhtIDBtVsC_42SE5kHT9FlHEBeAx/view?usp=sharing' target='_blank'><button>Ver video</button></a></div>", unsafe_allow_html=True) 
    ...
    st.markdown("<h1 style='text-align: center;'>Gráficos desarrollados a lo largo de mi experiencia</h1>", unsafe_allow_html=True)

    # Creamos una lista de gráficos
    graficos = ['Gráfico del Barcelona FC', 'Promedio de tarjetas rojas recibidas por cada equipo como equipo local (hometeam)', 'Resultados de partidos del Real Madrid como equipo local', 'Mis películas favoritas']
